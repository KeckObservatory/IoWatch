<h1>socket.io-parser</h1><p><a href="http://travis-ci.org/socketio/socket.io-parser"><img src="https://secure.travis-ci.org/socketio/socket.io-parser.svg?branch=master" alt="Build Status"></a>
...
<h2>Parser API</h2><p>  socket.io-parser is the reference implementation of socket.io-protocol. Read
  the full API here:
  <a href="https://github.com/learnboost/socket.io-protocol">socket.io-protocol</a>.</p>
<h2>Example Usage</h2><h3>Encoding and decoding a packet</h3><pre><code class="language-js">var parser = require(&#39;socket.io-parser&#39;);
...
<h3>Encoding and decoding a packet with binary data</h3><pre><code class="language-js">var parser = require(&#39;socket.io-parser&#39;);
var encoder = new parser.Encoder();
var packet = {
