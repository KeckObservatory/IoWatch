...
<h2>Installation</h2><pre><code class="language-sh">$ npm install cookie
</code></pre>
...
<h5>domain</h5><p>Specifies the value for the <a href="https://tools.ietf.org/html/rfc6266#section-5.2.3"><code>Domain</code> <code>Set-Cookie</code> attribute</a>. By default, no
...
<h5>expires</h5><p>Specifies the <code>Date</code> object to be the value for the <a href="https://tools.ietf.org/html/rfc6266#section-5.2.1"><code>Expires</code> <code>Set-Cookie</code> attribute</a>.
...
<h5>httpOnly</h5><p>Specifies the <code>boolean</code> value for the [<code>HttpOnly</code> <code>Set-Cookie</code> attribute][rfc-6266-5.2.6]. When truthy,
...
<h5>maxAge</h5><p>Specifies the <code>number</code> (in seconds) to be the value for the <a href="https://tools.ietf.org/html/rfc6266#section-5.2.2"><code>Max-Age</code> <code>Set-Cookie</code> attribute</a>.
The given number will be converted to an integer by rounding down. By default, no maximum age is set.</p>
<p><strong>note</strong> the <a href="https://tools.ietf.org/html/rfc6266#section-5.3">cookie storage model specification</a> states that if both <code>expires</code> and
<code>magAge</code> are set, then <code>maxAge</code> takes precedence, but it is possiblke not all clients by obey this,
so if both are set, they should point to the same date and time.</p>
<h5>path</h5><p>Specifies the value for the <a href="https://tools.ietf.org/html/rfc6266#section-5.2.4"><code>Path</code> <code>Set-Cookie</code> attribute</a>. By default, the path
...
<h5>sameSite</h5><p>Specifies the <code>boolean</code> or <code>string</code> to be the value for the <a href="https://tools.ietf.org/html/draft-west-first-party-cookies-07"><code>SameSite</code> <code>Set-Cookie</code> attribute</a>.</p>
<ul>
...
<h5>secure</h5><p>Specifies the <code>boolean</code> value for the [<code>Secure</code> <code>Set-Cookie</code> attribute][rfc-6266-5.2.5]. When truthy,
