<h2>11.0.0</h2><p>Breaking changes:</p>
<ul>
...
<h2>10.0.0</h2><p>This release includes a complete overhaul of jsdom&#39;s API for creating and manipulating jsdoms. The new API is meant to be much more intuitive and have better defaults, with complete documentation in the newly-overhauled README. We hope you like it!</p>
...
<h2>7.1.0</h2><p>This is a rather large release bringing with it several important re-implementations of DOM and HTML APIs.</p>
<ul>
...
<li>When you provide a <code>url: ...</code> option to <code>jsdom.jsom()</code> or <code>jsdom.env()</code>, the given string is now attempted to be resolved as a URL before it is installed as <code>document.URL</code>.<ul>
...
<h2>6.0.0</h2><p>This major release is focused on massive improvements in speed, URL parsing, and error handling. The potential breaking changes are highlighted in bold below; the largest ones are around the <code>jsdom.env</code> error-handling paradigm.</p>
...
<h2>5.4.0</h2><p>This is a pretty exciting release! It includes a couple features I never really anticipated jsdom being awesome enough to have, but our wonderful contributors powered through and made them happen anyway:</p>
<ul>
...
<h2>5.0.0</h2><p>This release overhauls how cookies are handled in jsdom to be less fiddly and more like-a-browser. The work for this was done by <a href="https://github.com/inikulin">@inikulin</a>, who is also our beloved parse5 maintainer.</p>
...
<h2>4.0.0</h2><p>This release relies on the newly-overhauled <code>vm</code> module of io.js to eliminate the Contextify native module dependency. jsdom should now be much easier to use and install, without requiring a C++ compiler toolchain!</p>
...
<h2>3.0.0</h2><p>This release updates large swathes of the DOM APIs to conform to the standard, mostly by removing old stuff. It also fixes a few bugs, introduces a couple new features, and changes some defaults.</p>
...
<h2>1.0.0</h2><p>For a consolidated list of changes from 0.11.1 to 1.0.0, see <a href="https://github.com/tmpvar/jsdom/wiki/Changes-from-0.11.1-to-1.0.0">this wiki page</a>.</p>
<ul>
...
<h3>Removed non-standard DOM APIs</h3><ul>
...
<h2>0.6.0</h2><p>Integrated a new HTML parser, <a href="https://npmjs.org/package/htmlparser2">htmlparser2</a>, from fb55. This is an actively maintained and much less buggy parser, fixing many of our parsing issues, including:</p>
<ul>
...
<h2>0.5.4</h2><p>This release, and all future releases, require at least Node.js 0.8.</p>
<ul>
...
<h2>0.5.3</h2><p>This release is compatible with Node.js 0.6, whereas all future releases will require at least Node.js 0.8.</p>
<ul>
