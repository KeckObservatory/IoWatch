<h1>Acorn</h1><p><a href="https://travis-ci.org/ternjs/acorn"><img src="https://travis-ci.org/ternjs/acorn.svg?branch=master" alt="Build Status"></a>
...
<h2>Installation</h2><p>The easiest way to install acorn is with <a href="https://www.npmjs.com/"><code>npm</code></a>.</p>
<pre><code class="language-sh">npm install acorn
</code></pre>
<p>Alternately, download the source.</p>
<pre><code class="language-sh">git clone https://github.com/ternjs/acorn.git
</code></pre>
...
<h4>Note on using with <a href="https://github.com/estools/escodegen">Escodegen</a></h4><p>Escodegen supports generating comments from AST, attached in
...
options:</p>
<ul>
<li><p><code>--ecma3|--ecma5|--ecma6|--ecma7</code>: Sets the ECMAScript version to parse. Default is
version 5.</p>
</li>
...
normal parser:</p>
<pre><code class="language-javascript">looseParser.extend(&quot;readToken&quot;, function(nextMethod) {
  return function() {
