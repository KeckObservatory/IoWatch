<h1>http-errors</h1><p><a href="https://npmjs.org/package/http-errors"><img src="https://img.shields.io/npm/v/http-errors.svg" alt="NPM Version"></a>
...
<h3>createError([status], [message], [properties])</h3><!-- eslint-disable no-undef, no-unused-vars -->
...
<h3>new createError[code || name]([msg]))</h3><!-- eslint-disable no-undef, no-unused-vars -->
