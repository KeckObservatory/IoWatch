<h1>Engine.IO client</h1><p><a href="http://travis-ci.org/socketio/engine.io-client"><img src="https://travis-ci.org/socketio/engine.io-client.svg?branch=master" alt="Build Status"></a>
...
<h2>How to use</h2><h3>Standalone</h3><p>You can find an <code>engine.io.js</code> file in this repository, which is a
...
<h3>With browserify</h3><p>Engine.IO is a commonjs module, which means you can include it by using
...
<pre><code class="language-bash"> $ npm install engine.io-client
</code></pre>
</li>
<li><p>write your app code</p>
<pre><code class="language-js"> var socket = require(&#39;engine.io-client&#39;)(&#39;ws://localhost&#39;);
 socket.on(&#39;open&#39;, function(){
   socket.on(&#39;message&#39;, function(data){});
   socket.on(&#39;close&#39;, function(){});
 });
...
<h3>Sending and receiving binary</h3><pre><code class="language-html">&lt;script src=&quot;/path/to/engine.io.js&quot;&gt;&lt;/script&gt;
&lt;script&gt;
...
<h3>Node.JS</h3><p>Add <code>engine.io-client</code> to your <code>package.json</code> and then:</p>
<pre><code class="language-js">var socket = require(&#39;engine.io-client&#39;)(&#39;ws://localhost&#39;);
socket.on(&#39;open&#39;, function(){
  socket.on(&#39;message&#39;, function(data){});
  socket.on(&#39;close&#39;, function(){});
...
<h3>Node.js with certificates</h3><pre><code class="language-js">var opts = {
...
<h3>Node.js with extraHeaders</h3><pre><code class="language-js">var opts = {
  extraHeaders: {
...
<h2>API</h2><h3>Socket</h3><p>The client class. Mixes in <a href="http://github.com/component/emitter">Emitter</a>.
...
<h3>Transport</h3><p>The transport class. Private. <em>Inherits from EventEmitter</em>.</p>
<h4>Events</h4><ul>
...
<h2>Tests</h2><p><code>engine.io-client</code> is used to test
...
<h2>Support</h2><p>The support channels for <code>engine.io-client</code> are the same as <code>socket.io</code>:</p>
<ul>
...
repository:</p>
<pre><code class="language-bash">git clone git://github.com/socketio/engine.io-client.git
</code></pre>
<p>Then:</p>
<pre><code class="language-bash">cd engine.io-client
npm install
</code></pre>
<p>See the <code>Tests</code> section above for how to run tests before submitting any patches.</p>
<h2>License</h2><p>MIT - Copyright (c) 2014 Automattic, Inc.</p>
