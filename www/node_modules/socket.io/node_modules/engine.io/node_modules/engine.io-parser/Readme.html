<h1>engine.io-parser</h1><p><a href="http://travis-ci.org/socketio/engine.io-parser"><img src="https://secure.travis-ci.org/socketio/engine.io-parser.svg" alt="Build Status"></a>
...
<h2>How to use</h2><h3>Standalone</h3><p>The parser can encode/decode packets, payloads, and payloads as binary
...
<p>Example:</p>
<pre><code class="language-js">var parser = require(&#39;engine.io-parser&#39;);
...
<h3>With browserify</h3><p>Engine.IO Parser is a commonjs module, which means you can include it by using
...
<h2>API</h2><p>Note: <code>cb(type)</code> means the type is a callback function that contains a parameter of type <code>type</code> when called.</p>
<h3>Node</h3><ul>
...
<h2>Tests</h2><p>Standalone tests can be run with <code>make test</code> which will run both node.js and browser tests.</p>
...
</code></pre><h2>Support</h2><p>The support channels for <code>engine.io-parser</code> are the same as <code>socket.io</code>:</p>
<ul>
...
repository:</p>
<pre><code class="language-bash">git clone git://github.com/LearnBoost/engine.io-parser.git
</code></pre>
<p>Then:</p>
