<h1>socket.io</h1><p><a href="#backers"><img src="https://opencollective.com/socketio/backers/badge.svg" alt="Backers on Open Collective"></a> <a href="#sponsors"><img src="https://opencollective.com/socketio/sponsors/badge.svg" alt="Sponsors on Open Collective"></a>
<a href="https://travis-ci.org/socketio/socket.io"><img src="https://secure.travis-ci.org/socketio/socket.io.svg?branch=master" alt="Build Status"></a>
<a href="https://david-dm.org/socketio/socket.io"><img src="https://david-dm.org/socketio/socket.io.svg" alt="Dependency Status"></a>
<a href="https://david-dm.org/socketio/socket.io#info=devDependencies"><img src="https://david-dm.org/socketio/socket.io/dev-status.svg" alt="devDependency Status"></a>
...
<h2>Features</h2><p>Socket.IO enables real-time bidirectional event-based communication. It consists in:</p>
<ul>
...
<h4>Reliability</h4><p>Connections are established even in the presence of:</p>
<ul>
...
<h4>Auto-reconnection support</h4><p>Unless instructed otherwise a disconnected client will try to reconnect forever, until the server is available again. Please see the available reconnection options <a href="https://github.com/socketio/socket.io-client/blob/master/docs/API.md#new-managerurl-options">here</a>.</p>
<h4>Disconnection detection</h4><p>An heartbeat mechanism is implemented at the Engine.IO level, allowing both the server and the client to know when the other one is not responding anymore.</p>
...
<h4>Binary support</h4><p>Any serializable data structures can be emitted, including:</p>
<ul>
...
<h4>Simple and convenient API</h4><p>Sample code:</p>
...
<h4>Cross-browser</h4><p>Browser support is tested in Saucelabs:</p>
<p><a href="https://saucelabs.com/u/socket"><img src="https://saucelabs.com/browser-matrix/socket.svg" alt="Sauce Test Status"></a></p>
<h4>Multiplexing support</h4><p>In order to create separation of concerns within your application (for example per module, or based on permissions), Socket.IO allows you to create several <code>Namespaces</code>, which will act as separate communication channels but will share the same underlying connection.</p>
<h4>Room support</h4><p>Within each <code>Namespace</code>, you can define arbitrary channels, called <code>Rooms</code>, that sockets can join and leave. You can then broadcast to any given room, reaching every socket that has joined it.</p>
...
<h2>Installation</h2><pre><code class="language-bash">npm install socket.io --save
</code></pre>
<h2>How to use</h2><p>The following example attaches socket.io to a plain Node.JS
HTTP server listening on port <code>3000</code>.</p>
<pre><code class="language-js">var server = require(&#39;http&#39;).createServer();
...
<h3>Standalone</h3><pre><code class="language-js">var io = require(&#39;socket.io&#39;)();
io.on(&#39;connection&#39;, function(client){});
io.listen(3000);
</code></pre>
<h3>In conjunction with Express</h3><p>Starting with <strong>3.0</strong>, express applications have become request handler
...
<h3>In conjunction with Koa</h3><p>Like Express.JS, Koa works by exposing an application as a request
...
<h2>Documentation</h2><p>Please see the documentation <a href="/docs/README.md">here</a>. Contributions are welcome!</p>
<h2>Debug / logging</h2><p>Socket.IO is powered by <a href="https://github.com/visionmedia/debug">debug</a>.
...
</code></pre><h2>Testing</h2><pre><code>npm test
</code></pre><p>This runs the <code>gulp</code> task <code>test</code>. By default the test will be run with the source code in <code>lib</code> directory.</p>
...
<h2>Backers</h2><p>Support us with a monthly donation and help us continue our activities. [<a href="https://opencollective.com/socketio#backer">Become a backer</a>]</p>
...
<h2>Sponsors</h2><p>Become a sponsor and get your logo on our README on Github with a link to your site. [<a href="https://opencollective.com/socketio#sponsor">Become a sponsor</a>]</p>
